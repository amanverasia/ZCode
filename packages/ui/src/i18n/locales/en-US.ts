...
const enUS: Record<string, string> = {
  ...
  "git.worktreeSwitcher.label": "Worktree",
  "git.worktreeSwitcher.trigger.ariaLabel": "Switch Git worktree",
  "git.worktreeSwitcher.searchPlaceholder": "Search worktrees",
  "git.worktreeSwitcher.empty": "No worktrees match",
  "git.worktreeSwitcher.main": "Main",
  "git.worktreeSwitcher.mainBadge": "main",
  "git.worktreeSwitcher.dirtyBadge": "dirty",
  "git.worktreeSwitcher.createAction": "New isolated task",
  "git.worktreeSwitcher.remove.ariaLabel": "Remove worktree",
  "git.worktreeSwitcher.createDialog.title": "Create isolated worktree",
  "git.worktreeSwitcher.createDialog.description":
    "Creates a linked Git worktree under .worktrees/<name> on a new branch, then opens it.",
  "git.worktreeSwitcher.createDialog.nameLabel": "Name",
  "git.worktreeSwitcher.createDialog.namePlaceholder": "feature-name",
  "git.worktreeSwitcher.createDialog.helper":
    "Path defaults to .worktrees/<name> beside the main tree. Branch name matches unless you change it later.",
  "git.worktreeSwitcher.createDialog.confirm": "Create and open",
  "git.worktreeSwitcher.forceRemove.title": "Remove dirty worktree?",
  "git.worktreeSwitcher.forceRemove.description":
    "This worktree has uncommitted changes. Force remove permanently deletes those files. This cannot be undone from ZCode.",
  "git.worktreeSwitcher.forceRemove.confirm": "Force remove",
  "git.worktreeSwitcher.toast.switchSuccess": "Opened worktree {name}",
  "git.worktreeSwitcher.toast.createSuccess": "Created worktree {name}",
  "git.worktreeSwitcher.toast.removeSuccess": "Removed worktree {name}",
  "git.worktreeSwitcher.error.invalidName": "Enter a valid worktree name.",
  "git.worktreeSwitcher.error.pathExists": "That worktree path already exists.",
  "git.worktreeSwitcher.error.branchExists": "That branch already exists.",
  "git.worktreeSwitcher.error.branchInOtherWorktree":
    "That branch is already checked out in another worktree.",
  "git.worktreeSwitcher.error.dirty":
    "Worktree has uncommitted changes. Commit, stash, or confirm force remove.",
  "git.worktreeSwitcher.error.mainProtected": "The main worktree cannot be removed.",
  "git.worktreeSwitcher.error.currentProtected":
    "Switch away from this worktree before removing it.",
  "git.worktreeSwitcher.error.notFound": "That worktree was not found.",
  "git.worktreeSwitcher.error.operationInProgress":
    "Another Git operation is still in progress.",
  "git.worktreeSwitcher.error.unknown": "Worktree operation failed. Please try again.",
  "git.worktreeSwitcher.error.requestFailed": "Worktree operation failed: {error}",
  ...
  "settings.shortcuts.command.applyModelProfileFast": "Apply FAST Model Profile",
  "settings.shortcuts.command.applyModelProfileDeep": "Apply DEEP Model Profile",
  "settings.shortcuts.command.applyModelProfileLocal": "Apply LOCAL Model Profile",
  "settings.shortcuts.command.applyModelProfileCheap": "Apply CHEAP Model Profile",
  "settings.shortcuts.command.cycleModelProfile": "Cycle Model Profile",
  ...
  "settings.modelProfiles.title": "Model profiles",
  "settings.modelProfiles.description":
    "Map FAST / DEEP / LOCAL / CHEAP to any provider and model. Bindings are vendor-agnostic — set your own endpoints in Model settings first.",
  "settings.modelProfiles.cycleHint": "Cycle profiles with {keys}. Apply also updates the active composer selection.",
  "settings.modelProfiles.shortcutHint": "Shortcut: {keys}",
  "settings.modelProfiles.activeBadge": "Active",
  "settings.modelProfiles.save": "Save",
  "settings.modelProfiles.apply": "Apply",
  "settings.modelProfiles.saved": "Profile saved",
  "settings.modelProfiles.incomplete":
    "Set provider and model for this profile in Settings → Model profiles before applying.",
  "settings.modelProfiles.markedActive": "Active profile: {profile}",
  "settings.modelProfiles.applied": "Switched to {profile} · {model}",
  "settings.modelProfiles.saving": "Saving…",
  "settings.modelProfiles.providerId": "Provider ID",
  "settings.modelProfiles.providerIdHint": "Exact provider id from Model settings (builtin or custom).",
  "settings.modelProfiles.modelId": "Model ID",
  "settings.modelProfiles.thoughtLevel": "Thought / reasoning level",
  "settings.modelProfiles.thoughtLevelHint": "Must match a level offered by the selected model (leave blank if none).",
  "settings.modelProfiles.temperature": "Temperature",
  "settings.modelProfiles.timeoutMs": "Timeout (ms)",
  "settings.modelProfiles.maxRetries": "Max retries",
  "settings.modelProfiles.retryBackoffMs": "Retry backoff (ms)",
  "settings.modelProfiles.fallbackModels": "Fallback models",
  "settings.modelProfiles.fallbackModelsHint": "Comma-separated provider/model pairs used when failover lands.",

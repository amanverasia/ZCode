...
const zhCN: Record<string, string> = {
  ...
  "git.worktreeSwitcher.label": "工作树",
  "git.worktreeSwitcher.trigger.ariaLabel": "切换 Git 工作树",
  "git.worktreeSwitcher.searchPlaceholder": "搜索工作树",
  "git.worktreeSwitcher.empty": "没有匹配的工作树",
  "git.worktreeSwitcher.main": "主工作树",
  "git.worktreeSwitcher.mainBadge": "主",
  "git.worktreeSwitcher.dirtyBadge": "未提交",
  "git.worktreeSwitcher.createAction": "新建隔离任务",
  "git.worktreeSwitcher.remove.ariaLabel": "移除工作树",
  "git.worktreeSwitcher.createDialog.title": "创建隔离工作树",
  "git.worktreeSwitcher.createDialog.description":
    "在 .worktrees/<name> 下创建关联 worktree 与新分支，并打开该工作区。",
  "git.worktreeSwitcher.createDialog.nameLabel": "名称",
  "git.worktreeSwitcher.createDialog.namePlaceholder": "feature-name",
  "git.worktreeSwitcher.createDialog.helper":
    "默认路径为主仓库旁的 .worktrees/<name>，分支名默认与名称相同。",
  "git.worktreeSwitcher.createDialog.confirm": "创建并打开",
  "git.worktreeSwitcher.forceRemove.title": "强制移除未提交的工作树？",
  "git.worktreeSwitcher.forceRemove.description":
    "该工作树仍有未提交更改。强制移除会永久删除这些文件，ZCode 无法撤销。",
  "git.worktreeSwitcher.forceRemove.confirm": "强制移除",
  "git.worktreeSwitcher.toast.switchSuccess": "已打开工作树 {name}",
  "git.worktreeSwitcher.toast.createSuccess": "已创建工作树 {name}",
  "git.worktreeSwitcher.toast.removeSuccess": "已移除工作树 {name}",
  "git.worktreeSwitcher.error.invalidName": "请输入有效的工作树名称。",
  "git.worktreeSwitcher.error.pathExists": "该工作树路径已存在。",
  "git.worktreeSwitcher.error.branchExists": "该分支已存在。",
  "git.worktreeSwitcher.error.branchInOtherWorktree": "该分支已在其他工作树中被检出。",
  "git.worktreeSwitcher.error.dirty": "工作树有未提交更改。请先提交、暂存，或确认强制移除。",
  "git.worktreeSwitcher.error.mainProtected": "不能移除主工作树。",
  "git.worktreeSwitcher.error.currentProtected": "请先切换到其他工作树，再移除当前工作树。",
  "git.worktreeSwitcher.error.notFound": "未找到该工作树。",
  "git.worktreeSwitcher.error.operationInProgress": "当前仍有进行中的 Git 操作。",
  "git.worktreeSwitcher.error.unknown": "工作树操作失败，请稍后重试。",
  "git.worktreeSwitcher.error.requestFailed": "工作树操作失败：{error}",
  ...
  "settings.shortcuts.command.applyModelProfileFast": "应用 FAST 模型配置",
  "settings.shortcuts.command.applyModelProfileDeep": "应用 DEEP 模型配置",
  "settings.shortcuts.command.applyModelProfileLocal": "应用 LOCAL 模型配置",
  "settings.shortcuts.command.applyModelProfileCheap": "应用 CHEAP 模型配置",
  "settings.shortcuts.command.cycleModelProfile": "循环切换模型配置",
  ...
  "settings.modelProfiles.title": "模型配置档",
  "settings.modelProfiles.description":
    "将 FAST / DEEP / LOCAL / CHEAP 映射到任意供应商与模型。绑定与厂商无关——请先在「模型设置」中配置端点。",
  "settings.modelProfiles.cycleHint": "使用 {keys} 循环切换配置档。应用也会更新当前输入框的模型选择。",
  "settings.modelProfiles.shortcutHint": "快捷键：{keys}",
  "settings.modelProfiles.activeBadge": "当前",
  "settings.modelProfiles.save": "保存",
  "settings.modelProfiles.apply": "应用",
  "settings.modelProfiles.saved": "配置档已保存",
  "settings.modelProfiles.incomplete":
    "请先在 设置 → 模型配置档 中填写该档的供应商与模型，再应用。",
  "settings.modelProfiles.markedActive": "当前配置档：{profile}",
  "settings.modelProfiles.applied": "已切换到 {profile} · {model}",
  "settings.modelProfiles.saving": "保存中…",
  "settings.modelProfiles.providerId": "供应商 ID",
  "settings.modelProfiles.providerIdHint": "与「模型设置」中的供应商 ID 完全一致（内置或自定义）。",
  "settings.modelProfiles.modelId": "模型 ID",
  "settings.modelProfiles.thoughtLevel": "思考 / 推理档位",
  "settings.modelProfiles.thoughtLevelHint": "须与所选模型提供的档位一致（无则留空）。",
  "settings.modelProfiles.temperature": "温度",
  "settings.modelProfiles.timeoutMs": "超时（毫秒）",
  "settings.modelProfiles.maxRetries": "最大重试次数",
  "settings.modelProfiles.retryBackoffMs": "重试退避（毫秒）",
  "settings.modelProfiles.fallbackModels": "回退模型",
  "settings.modelProfiles.fallbackModelsHint": "逗号分隔的 provider/model 对，供后续故障切换使用。",

...
const zhCN: Record<string, string> = {
  ...
  "settings.shortcuts.command.applyModelProfileFast": "应用模型档案：FAST",
  "settings.shortcuts.command.applyModelProfileDeep": "应用模型档案：DEEP",
  "settings.shortcuts.command.applyModelProfileLocal": "应用模型档案：LOCAL",
  "settings.shortcuts.command.applyModelProfileCheap": "应用模型档案：CHEAP",
  "settings.shortcuts.command.cycleModelProfile": "循环切换模型档案",
  ...
  "settings.modelProfiles.title": "模型档案",
  "settings.modelProfiles.description": "为 FAST、DEEP、LOCAL、CHEAP 工作流定义可复用的模型预设。",
  "settings.modelProfiles.cycleHint": "循环切换当前档案：{keys}",
  "settings.modelProfiles.saved": "模型档案已保存。",
  "settings.modelProfiles.activeBadge": "已激活",
  ...
  "settings.modelProfiles.providerIdHint": "该档案使用的 provider 标识。",
  "settings.modelProfiles.modelId": "Model ID",
  "settings.modelProfiles.thoughtLevel": "思考深度",
  "settings.modelProfiles.thoughtLevelHint": "该档案发送时附带的推理档位。",
  ...
  "settings.modelProfiles.fallbackModels": "兜底模型",
  "settings.modelProfiles.fallbackModelsHint":
    "当主模型失败时使用的 provider/model 列表，多个条目用逗号分隔。",
  "settings.modelProfiles.incomplete": "请先填写 provider ID 和 model ID。",
  "settings.modelProfiles.applied": "已应用 {profile} 档案（{model}）。",
